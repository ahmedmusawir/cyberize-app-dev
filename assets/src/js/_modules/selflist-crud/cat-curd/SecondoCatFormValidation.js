...
class SecondoCatFromValidation extends CatFormValdationParent {
  constructor() {
    ...
    this.secondoCatUserValidationCancelBtn = $('#secondo-cat-insert-cancel-btn');
  ...
  setEvents = () => {
    ...
    this.secondoCatUserValidationCancelBtn.on('click', this.catUserValidationCancelHandler);
  }
}
