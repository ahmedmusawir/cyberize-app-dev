...
<main id="primary" class="site-main container customer-profile-page">
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-8">
      ...
      <h3 class="text-uppercase"><small class="font-weight-bold">Customer List Archive</small></h3>
      <h2 class="h2"><?php echo $current_user->display_name; ?>'s List Archive</h2>
      <hr>
      <h5 class="font-weight-bold">PUBLISHED LISTS:</h5>
      <?php 
      ...
      ?>
      <h5 class="font-weight-bold">UNPUBLISHED LISTS:</h5>
      <?php 
