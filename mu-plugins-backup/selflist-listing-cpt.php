...
function Listings_cpt() {
  	...
  	$args = array(
  		...
  		'capability_type'    => 'listings', // This makes listings exclusive to set roles and perms
  		'map_meta_cap'       => true, // This allows to customize the capabilities. See selflist-user-roles.php file
      // 'taxonomies'          => array( 'property-type', 'listing-status' ), // This enables the custom taxonomies
  		'has_archive'        => true,
  		'hierarchical'       => true,
  		'menu_position'      => null,
...
function create_Listings_taxonomies() {
...
// add_action( 'init', 'create_Listings_taxonomies', 0 );