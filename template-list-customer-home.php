...
<main id="primary" class="site-main container customer-profile-page">
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-8">
      ...
      <form action="" name="password-reset-form" id="password-reset-form" class="form">
        ...
        <div class="form-group">
          <input type="password" class="form-control" id="lister-password" name="lister-password"
            aria-describedby="textHelp" placeholder="Your Name" value="<?php echo $current_user->user_pass ?>" readonly>
      ...
      <div class="mt-5">
        <button id="additional-info-cancel-btn" class="btn btn-primary btn-sm float-right ml-2" disabled>Cancel</button>
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-2">
                ...
                <input type="url" class="form-control" id="lister-facebook" name="lister-facebook"
                  placeholder="https://facebook.com/mypage" value="<?php echo $user_facebook; ?>" readonly>
              </div>
            ...
            <div class="form-group">
              <div class="input-group mb-2">
                ...
                <input type="url" class="form-control" id="lister-instagram" name="lister-instagram"
                  placeholder="https://instagram.com/mypage" value="<?php echo $user_instagram; ?>" readonly>
              </div>
            ...
            <div class="form-group">
              <div class="input-group mb-2">
                ...
                <input type="url" class="form-control" id="lister-linkedin" name="lister-linkedin"
                  placeholder="https://linkedin.com/mypage" value="<?php echo $user_linkedin; ?>" readonly>
              </div>
            ...
            <div class="form-group">
              <div class="input-group mb-2">
                ...
                <input type="url" class="form-control" id="lister-google-plus" name="lister-google-plus"
                  placeholder="https://googleplus.com/mypage" value="<?php echo $user_google_plus; ?>" readonly>
              </div>
            ...
            <div class="form-group">
              <div class="input-group mb-2">
                ...
                <input type="url" class="form-control" id="lister-twitter" name="lister-twitter"
                  placeholder="https://twitter.com/mypage" value="<?php echo $user_twitter; ?>" readonly>
              </div>
              <small id="textHelp" class="form-text text-muted">Example: https://twitter.com/mypage</small>
            </div>

            <!-- THE SUBMIT BUTTON -->
            <button id="profile-info-update-button" type="submit" class="btn btn-secondary btn-block" disabled>
              Update Information
            </button>
